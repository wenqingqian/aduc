...
__global__ void r1_HideSmemLatencyKernel(const float *__restrict__ A,
...
void r1_HideSmemLatency(const float *deviceAPtr, const float *deviceBPtr,
  ...
  r1_HideSmemLatencyKernel<layoutTile, layoutBlock, layoutThread><<<grid, block>>>(
