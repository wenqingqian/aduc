...
__global__ void r1_ShareMemKernel(const float *__restrict__ A,
...
void r1_ShareMem(const float *deviceAPtr, const float *deviceBPtr,
  ...
  r1_ShareMemKernel<layoutTile, layoutBlock, layoutThread><<<grid, block>>>(
